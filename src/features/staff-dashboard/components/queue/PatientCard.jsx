        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <div>
              ...
              <p className="text-gray-600">Check-in: {patient.checkInTime}</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2 text-sm">
            ...
            <div>
              ...
              <p className="text-gray-600">Preferred</p>
            </div>
          </div>
            ...
            <div
              className={`w-4 h-4 rounded-full ${
                getWaitTimeColor(patient.waitTime) === "text-red-600"
                  ? "bg-red-500"
                  : getWaitTimeColor(patient.waitTime) === "text-yellow-600"
                  ? "bg-yellow-500"
                  : "bg-green-500"
              }`}
            />
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              <Tooltip>
                ...
                <TooltipContent>Move up in queue</TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent>Move down in queue</TooltipContent>
              </Tooltip>
            </div>

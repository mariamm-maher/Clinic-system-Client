  ...
  return (
    <div className="text-center py-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-dashed border-blue-200">
      ...
      <h3 className="text-xl font-bold text-gray-900 mb-2">
        {hasFilters ? "No patients match filters" : "Queue is empty"}
      </h3>

      <p className="text-gray-600 mb-6 max-w-md mx-auto">
        {hasFilters
          ? "Try adjusting your search criteria or filters to see more patients."
          : "No patients are currently waiting. All appointments are up to date!"}
      </p>

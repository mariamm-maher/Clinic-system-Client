...
export default function QueueManagement() {
  ...
  const [queue, setQueue] = useState([
    ...
    },
    {
      ...
      status: "in-progress",
      priority: "normal",
      estimatedWait: "In examination",
      roomPreference: "Room 2",
  ...
  return (
    <TooltipProvider>
      <div className="space-y-6 p-6 bg-gradient-to-br from-slate-50 via-blue-50/30 to-green-50/30 min-h-screen">
        {/* Header Section */}
        <QueueHeader
          viewMode={viewMode}
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              <span className="text-xl font-bold text-gray-900">
                Current Queue ({filteredQueue.length} patients)
              </span>
